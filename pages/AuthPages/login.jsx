...
import {collection,doc,setDoc,getDocs,orderBy,query,getFirestore,updateDoc} from "firebase/firestore"
...
function Login(){
      ...
      try{
        await signInWithEmailAndPassword(auth,email,pwd).then((response)=>{
            updateDoc(
    ...
    return(
        ...
        <link rel="icon" href="/ChitChat.png" />
      </Head>
        ...
        <div className="p-3 mt-[80px]">
            ...
            <div className='flex flex-col items-center justify-center mt-[80px] gap-[20px]'>
                ...
                <label>Password</label><br/>
                    <input type="password" required className='border-[1px] w-[350px] p-3 mt-[20px] rounded-3xl h-[60px]' value={pwd} onChange={(e)=>setPwd(e.target.value)}/>
                </div>
